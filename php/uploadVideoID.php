...
if(!$video_error) {
  ...
  echo exec("/volume1/@appstore/ffmpeg/bin/ffmpeg -i $new_path_video -qscale:v 4 -ss 00:00:00.010 -vframes 1 -vf scale=500:-1 $video_upload_folder$word-thumb.jpg >/dev/null 2>/dev/null &");
